...
Using NVidia Visual Profiler, the following data has been extracted for a more complex analysis, executing both algorithms for a graph composed of 512 nodes.

\begin{center}
    \begin{tabular}{ |c|c|c| }
    \hline
    \textbf{Statistic} & \textbf{Source Partitioned version} & \textbf{Source Parallel version} \\ \hline
    Warp execution efficiency & 89.9\%  & 0.48 \\ \hline
    Shared Memory Load Throughput & 0 B/s & 0.36 \\ \hline
    Shared Memory Store Throughput & 0 B/s & 0.16 \\ \hline
    Theoretical Occupancy & 50\% & NA \\ \hline
    Obtained Occupancy & 24\% & NA \\ \hline
    \end{tabular}
\end{center}
