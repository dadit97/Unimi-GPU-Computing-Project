...
Then the Vt cell of the closest node is set to true and the l array is updated with the minimum between the the current value and the
...
The shared memory initialization contains an additional vector, the minimumValues and minimumIndexes arrays, used during the computation of the local minimum,ù
...
The tests have been performed on a machine with a NVidia GeForce GTX 1050, with these basic specifications:\\
...
The performances in terms of execution time have been summarized into the followuing chart:
